...
function closeBoxes(){
  ...
  $(".cross-box").mouseover(function(){
    $(this).attr('src', "images/redcross.png")
  });
...
function projectsInfo(){
  // Projects: show info on hover and make other projects opaque
   $(".project-refugapp").on("mouseover", function(){
    ...
    $(this).css("opacity", "1");
    $(".footer-projects").text("Refugapp is a project we worked on during a Ruby on Rails course with Le Wagon. We created a platform to bring locals and refugees together by exchanging skills. (offline)");
  })

   $(".project-sneakertours").on("mouseover", function(){
    $(".project-img").css("opacity", "0.6");
    $(this).css("opacity", "1");
    $(".footer-projects").html("Sneakertours is a website I created with a friend to share the best places and events in Amsterdam. New site in progress: <a href='http://sneakertours.herokuapp.com' target='_blank'>sneak preview</a>");
  })

   $(".project-plankgasten").on("mouseover", function(){
    $(".project-img").css("opacity", "0.6");
    $(this).css("opacity", "1");
    $(".footer-projects").text("Plankgasten is a monthly open mic in CREA that I initiated and organised. After a short course I created this website. (offline)");
  })
}
